...
const TermsConditionsPage: NextPage = async () => {
  let faqItems: FAQItem[] = [];
  
  try {
    const faqResponse = await getFAQItems('legal');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-[48px] leading-[130%] font-bold text-gray-300 mb-4">
              Terms of Use – Independent Canadian Casino Review Site
            </h1>
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-300 mb-4">
                Provincial Age Requirements in Canada
              </h2>
              <p className="text-lg leading-[150%] text-gray-100 font-onest mb-6">
                It is the user's responsibility to understand and comply with the specific legal gambling age in their province or territory of residence.
              </p>
                ...
                <table className="w-full border-collapse border border-gray-300 bg-white rounded-lg">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-gray-300 px-4 py-3 text-left font-semibold text-gray-300">
                        Province/Territory
                      </th>
                      <th className="border border-gray-300 px-4 py-3 text-left font-semibold text-gray-300">
                  ...
                  <tbody>
                    {[
                      { province: 'Alberta', age: '18' },
                      { province: 'British Columbia', age: '19' },
                      { province: 'Manitoba', age: '18' },
                      { province: 'New Brunswick', age: '19' },
                      { province: 'Newfoundland and Labrador', age: '19' },
                      { province: 'Northwest Territories', age: '19' },
                      { province: 'Nova Scotia', age: '19' },
                      { province: 'Nunavut', age: '19' },
                      { province: 'Ontario', age: '19' },
                      { province: 'Prince Edward Island', age: '19' },
                      { province: 'Quebec', age: '18' },
                      { province: 'Saskatchewan', age: '19' }
                    ].map((item, index) => (
          ...
          <FAQ 
            items={faqItems}
            title="FAQ – Your Legal Questions Answered"
            className="mt-16"
          />
        </div>
      </div>
